    ...
    inline_help_dicts = [
        {
            ...
            "thumb_urL": "https://telegra.ph//file/ce58757fd928a7dab1522.jpg",
            "keyboard": ".spb ",
        },
        {
            "title": "Account info on Shiina",
            "description": "Look up a Telegram account in Shiina database",
            "message_text": "Click the button below to look up a person in Shiina database using their Telegram ID",
            "thumb_urL": "https://telegra.ph//file/c4703664967a8aaf610d7.jpg",
            "keyboard": ".info ",
        },
        {
            "title": "About",
            "description": "Know about Shiina",
            "message_text": "Click the button below to get to know about Shiina.",
            "thumb_urL": "https://telegra.ph//file/ce58757fd928a7dab1522.jpg",
            "keyboard": ".about ",
        },
        {
...
def inlineinfo(query: str, update: Update, context: CallbackContext) -> None:
    ...
    if user.id == OWNER_ID:
        ...
        text += f"\n\nThis Person is a part Developer of Shiina"
        nation_level_present = True
...
def about(query: str, update: Update, context: CallbackContext) -> None:
    ...
    results.append(
        InlineQueryResultPhoto(
            ...
            thumb_url="https://telegra.ph//file/c4703664967a8aaf610d7.jpg",
            photo_url="https://telegra.ph//file/ce58757fd928a7dab1522.jpg",
            caption=about_text,
...
def spb(query: str, update: Update, context: CallbackContext) -> None:
    ...
    results = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph//file/3ce0f3530fc4fe23ac463.jpg",
...
def help(query: str, update: Update, context: CallbackContext) -> None:
    ...
    results.append(
        InlineQueryResultPhoto(
            ...
            title="Help Commands",
            thumb_url="https://telegra.ph//file/ce58757fd928a7dab1522.jpg",
            photo_url="https://telegra.ph//file/3ce0f3530fc4fe23ac463.jpg",
            caption=help_text,
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=kb,
        )
